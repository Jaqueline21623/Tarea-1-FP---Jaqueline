...
public void crearProducto() {
    ...
    mostrarCategoria();
    pTo.setIdCat(leerT.leer("", "Seleccione un categoria"));
    pTo.setIdMod(leerT.leer("", "Seleccione un modelo"));
    pTo.setPrecioProducto(leerT.leer(0.0, "ingrese el Precio Unitario"));
    ...
    pTo.setPorcentajeDescuento(leerT.leer("", "Ingrese cantidad descuento"));
    leerA=new LeerArchivo(TABLA_PRODUCTO);
